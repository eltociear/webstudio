export const prompt = `You are given a comma separated list of CSS tokens:
...
- Only the CSSPropertyNames in the types can be overriden. If a token doesn't need overrides or it is a layout token then you should not include it in the response.
